    ...
    MobileArea.prototype = {
        ...
        bindEvent: function() {
            ...
            function popupArea(e) {
                ...
                _self.gearArea.innerHTML = '<div id="J_area_wrap" class="area_ctrl slideInUp">' +
                ...
                var larea_mask = _self.gearArea.querySelector(".area_mask");
                larea_mask.addEventListener('touchstart', function(e) {
                    _self.close(e);
                });
        ...
        close: function(e) {
            ...
            document.getElementById('J_area_wrap').className='area_ctrl slideInDown';
            $('.area_mask').fadeOut();
            setTimeout(function(){
                $('.gearArea').remove();
            },200)
