...
(function(win) {
    ...
    var L = location,
        ...
        isFrameElements = (win.frameElement == null) && doc.documentElement,
    ...
    addEventListener(win, 'load', function(ev){
    ...
    // 页面卸载之前收集卸载时间信息
    addEventListener(win, 'beforeunload', function(ev){
